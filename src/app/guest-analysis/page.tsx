...
import { Mic, Square, Volume2, Loader, ArrowLeft } from 'lucide-react'
...
/**
 * Página de análise para usuários não autenticados
 * Mantém a funcionalidade original sem persistência de dados
 */
export default function GuestAnalysisPage() {
  ...
  const transcreverAudio = async (audioBlob: Blob): Promise<string> => {
    const response = await fetch('/api/guest-transcribe', { method: 'POST', body: audioBlob })
          ...
          <div className="content-flex">
            <div style={{ flex: 1 }}>
              <h1 className="question-text">
                ...
                <span className="question-highlight">Modo Convidado</span>
              </h1>
              ...
              <p style={{
                ...
                Experimente nossa análise narrativa. Seus dados não serão salvos neste modo.
              </p>
